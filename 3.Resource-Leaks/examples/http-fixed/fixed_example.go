...
func (gw *APIGateway) fetchDataCorrectly() ([]byte, error) {
	...
	// ✅ FIX: Always close response body with defer
	defer func() {
		// Read and discard remaining body to enable connection reuse
	...
	// Response body will be closed automatically by defer
	return data, nil
}
